"""Shared fixtures for S3 and ACM integration tests."""
...
@pytest.fixture
def acm_client():
    """Create ACM client with environment-based configuration."""
    return boto3.client(
        "acm",
        endpoint_url=os.environ.get("FLOCI_ENDPOINT", "http://localhost:4566"),
        region_name=os.environ.get("AWS_DEFAULT_REGION", "us-east-1"),
...
@pytest.fixture
def test_certificate(acm_client):
